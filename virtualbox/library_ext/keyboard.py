...
class IKeyboard(library.IKeyboard):
    ...
    SCANCODES = {
        ...
        'INS':    [[0x52], [0xD2]], 
        'DEL':    [[0x53], [0xD3]],
        'E_DIV':  [[0xE0, 0x54], [0xD4]], 
        'E_ENTER':[[0xE0, 0x1C], [0x9C]],
        'E_INS':  [[0xE0, 0x52], [0xD2]],
        'E_DEL':  [[0xE0, 0x53], [0xD3]],
        'E_HOME': [[0xE0, 0x47], [0xC7]], 
        'E_END':  [[0xE0, 0x4F], [0xCF]], 
        'E_PGUP': [[0xE0, 0x49], [0xC9]], 
        'E_PGDN': [[0xE0, 0x51], [0xD1]], 
        'E_LEFT': [[0xE0, 0x4B], [0xCB]], 
        'E_RIGHT':[[0xE0, 0x4D], [0xCD]], 
        'E_UP':   [[0xE0, 0x48], [0xC8]], 
        'E_DOWN': [[0xE0, 0x50], [0xD0]], 
        'RALT':   [[0x0C, 0x38], [0xB8]], 
        'RCTRL':  [[0x0C, 0x1D], [0x9D]], 
